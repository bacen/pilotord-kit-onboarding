 ...
 * realizem a operação de compromissada intraday na ida envolvendo Título Público Federal tokenizado (TPFt) 
 ...
 */
async function tradeRepoIntradayByCNPJ8() {
  /**
  ...
  const senderTransaction = await TPFtOperation1054
    .connect(sender)
    ?.[
      "tradeRepoIntraday(uint256,uint256,uint256,uint8,(string,string,uint256),uint256,uint256)"
    ](
      params.operationId,
      params.cnpj8Sender,
 ...
 * no Real Digital através da função approve e no TPFt através setApprovalForAll.
 */
async function tradeRepoIntradayByAddresses() {
  ...
  const senderTransaction = await TPFtOperation1054
    .connect(sender)
    ?.[
      "tradeRepoIntraday(uint256,address,address,uint8,(string,string,uint256),uint256,uint256)"
    ](
      params.operationId,
      sender.address,
      receiver.address,
 ...
 * no Real Digital através da função approve e no TPFt através setApprovalForAll.
 */
async function tradeRepoIntradayByAddressesParticipantClient() {
  ...
  const senderTransaction = await TPFtOperation1054
    .connect(sender)
    ?.[
      "tradeRepoIntraday(uint256,address,address,address,address,uint8,(string,string,uint256),uint256,uint256)"
    ](
      params.operationId,
      senderAddress,
